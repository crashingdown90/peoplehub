...
describe("AnnouncementService", () => {
  ...
  describe("getAnnouncements", () => {
    it("should return published announcements for EMPLOYEE", async () => {
      ...
      const result = await AnnouncementService.getAnnouncements(employeeContext, {});
    ...
    it("should return all announcements for HRD", async () => {
      ...
      const result = await AnnouncementService.getAnnouncements(hrdContext, {});
    ...
    it("should filter by status for HRD", async () => {
      ...
      await AnnouncementService.getAnnouncements(hrdContext, { status: "DRAFT" });
