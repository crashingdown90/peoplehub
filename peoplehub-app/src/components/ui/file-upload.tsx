...
// @ai:cx - File upload with drag/drop
...
export function FileUpload({ accept, multiple = false, maxSizeMb = 5, onChange, className }: FileUploadProps) {
    ...
    return (
        <div className={cn("space-y-2", className)}>
            ...
            >
                ...
                <p className="text-sm font-medium text-slate-800">Tarik & lepas file atau klik untuk pilih</p>
                <p className="text-xs text-slate-500">
                    {multiple ? "Boleh beberapa file" : "Satu file"} · Maks {maxSizeMb}MB
                </p>
