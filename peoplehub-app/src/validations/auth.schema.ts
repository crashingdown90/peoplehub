...
export const registerSchema = z.object({
    ...
    phone: z
        ...
        .regex(INDONESIA_PHONE_REGEX, 'Format nomor telepon tidak valid (contoh: 08123456789)'),
    password: z
        .string()
    ...
    birthPlace: z.string().min(2, 'Tempat lahir minimal 2 karakter').max(50, 'Tempat lahir maksimal 50 karakter'),
    ...
    bankAccountHolder: z.string().min(3, 'Nama pemilik rekening minimal 3 karakter').max(100, 'Nama maksimal 100 karakter'),
    ...
    emergencyContactName: z.string().max(100, 'Nama kontak maksimal 100 karakter').optional(),
    ...
    agreedToTerms: z
        .boolean()
        .refine((val) => val === true, 'Anda harus menyetujui ketentuan penggunaan'),
    agreedToPrivacy: z
        .boolean()
